...
import com.ccavenue.dubaisdk.externalModel.AvenuesTransactionCallBack 
import com.ccavenue.dubaisdk.externalModel.AvenuesTransactionCallBack.StateListener

class CCAvenueModule(private val reactContext: ReactApplicationContext)
    : ReactContextBaseJavaModule(reactContext) ,AvenuesTransactionCallBack.StateListener {
