...
export default function DocUpload() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flex:1,justifyContent:'flex-end',bottom:'2%',paddingHorizontal:'5%'}}>
         <TouchableOpacity style={styles.submitBtn} onPress={()=>navigation.navigate("DocSubmitted")}>
