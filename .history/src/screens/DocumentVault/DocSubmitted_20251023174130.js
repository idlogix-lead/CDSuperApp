...
export default function DocSubmitted() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={[styles.mainTitle, {fontSize: 16, textAlign: 'center'}]}>
        Document Submitted
      </Text>

      <View style={styles.inputWrapper}>
        <Text style={styles.text}>
          Your document is pending verification. You’ll receive a notification
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('DocCenter')}>
