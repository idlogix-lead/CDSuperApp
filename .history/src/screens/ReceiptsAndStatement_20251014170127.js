...
export default function ReceiptsAndStatement() {
  const receipts = [
    {
      id: 1,
      status: 'Pending',
  ...
  return (
    <View style={styles.container}>
      ...
      <Header title={'RECEIPTS & STATEMENTS'} />
      {/* Title Section */}
      ...
      <Text style={styles.helper}>
        <Text style={{fontWeight: '700'}}>Helper:</Text> (Branded, date-stamped
        PDFs with transaction IDs.)
      </Text>
