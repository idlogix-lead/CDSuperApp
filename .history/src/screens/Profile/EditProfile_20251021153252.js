...
export default function EditProfile  () {
  ...
  const [selectedNationality,setSelectedNationality]= useState(Nationality[0]);
  ...
  <View style={styles.container}>
      ...
      <Text style={[styles.text,{fontSize:14}]}>Please update your profile</Text>
      ...
      <View style={styles.inputWrapper}>
        ...
        <TouchableOpacity style={styles.profileBtn} onPress={()=>navigation.navigate("EditSuccess")}>
