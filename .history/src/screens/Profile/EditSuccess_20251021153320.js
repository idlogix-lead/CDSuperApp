...
export default function EditSuccess  () {
  ...
  <View style={styles.container}>
      ...
      <Text style={styles.text}>Your update has been submitted for verification and will appear once approved.</Text>
        
        
        <TouchableOpacity style={styles.profileBtn} onPress={()=>navigation.navigate("MainDrawer")}>
