...
export default function KycSuccess  () {
  ...
  <View style={styles.container}>
      ...
      <Text style={styles.text}>Thank you! Your KYC insights have been saved successfully.</Text>
      <Text style={styles.text}> You’ll be notified if we need any further information.</Text>
