...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, StatusBar, Image, TextInput } from 'react-native';
...
export default function PaymentFailedScreen() {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Scrollable content */}
            <View style={{ flex: 1, justifyContent: 'flex-start', width: '100%', bottom: 10 , marginTop:'50%'}}>
                ...
                <Text style={styles.title}>Payment failed, please try again</Text>
                    ...
                    <TouchableOpacity style={styles.proceedBtn} onPress={() => navigation.navigate('PAYMENT Proof')}>
