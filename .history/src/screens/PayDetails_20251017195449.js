  ...
  const pay = async () => {
    try {
      const result = await CCAvenueModule.payCCAvenue({
        ...
        currency: 'AED',
        amount: '500.00',
        redirect_url: 'https://secure.ccavenue.ae/transaction/transaction.do?command=initiateTransaction',
        cancel_url: 'https://secure.ccavenue.ae/transaction/transaction.do?command=initiateTransaction',
        order_id: '1132387',
