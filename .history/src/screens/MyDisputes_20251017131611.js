...
export default function MyDisputes({navigation}) {
  const disputes = [
    ...
    {id: 6, status: 'close', resolveBy: '15 Jan 2025'},
    {id: 7, status: 'time', resolveBy: '15 Jan 2025'},
    {id: 8, status: 'set', resolveBy: '15 Jan 2025'},
    {id: 9, status: 'select', resolveBy: '15 Jan 2025'},
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('RemindersAndNotifications')}
