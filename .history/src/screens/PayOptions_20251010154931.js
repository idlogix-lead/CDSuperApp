  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.cardBox}>
          <View style={styles.cardIcons}>
            ...
            <View style={styles.payIcons}>
              ...
              <Image source={require('../../../asset/images/Contactless.png')} />

              <View style={{flexDirection:'row', alignItems:'center', backgroundColor:'white',padding:2,borderRadius:3}}>
                <Ionicons name='logo-apple' size={12} color={'#000'} />
                <Text style={{marginLeft:4, fontSize:12}}>Pay</Text>
              </View>

              <View style={{flexDirection:'row', alignItems:'center', backgroundColor:'white',padding:2,borderRadius:8}}>
                <Image source={require('../../../asset/images/logo_Google.png')} />
                <Text style={{marginLeft:4, fontSize:12}}>Pay</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.cardFooter}>
            <View style={{flexDirection:'row'}}>
              <View><Text style={styles.validText}>VALID THRU</Text></View>
              <View><Text style={styles.expiry}>01/22</Text></View>
            </View>
          </View>
        ...
        {/* Proceed Button */}
        <TouchableOpacity style={styles.proceedBtn} onPress={()=>navigation.navigate('PAYMENT DETAILS')}>
