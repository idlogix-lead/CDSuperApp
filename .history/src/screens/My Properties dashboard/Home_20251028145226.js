      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.featuredContainer}>
          <View style={styles.propertyImage}>
            <Image
              source={{
                uri: 'file:///C:/Users/HP/AppData/Local/Microsoft/Windows/INetCache/IE/FL9UVKMO/arya-banner[1].webp',
              }}
          ...
          <View style={styles.propertyInfo}>
            ...
            <Text style={styles.propertyDetail}>Price: 14000</Text>
            <Text style={styles.propertyDetail}>Location: XYZ</Text>
          </View>
        </View>
        ...
        <View style={styles.notificationsContainer}>
          {notifications.map(note => (
            <TouchableOpacity key={note.id} style={styles.notificationBox}>
              ...
              <Entypo name="chevron-right" size={16} color="#000" />
            </TouchableOpacity>
          ))}
        </View>
        ...
        <TouchableOpacity
          ...
          <Text style={[styles.viewAll, {color: '#7d662d'}]}>
            {' '}
...
const styles = StyleSheet.create({
  ...
  detailText: {fontSize: 12, marginVertical: 2},
  notificationText: {
    fontSize: 12,
