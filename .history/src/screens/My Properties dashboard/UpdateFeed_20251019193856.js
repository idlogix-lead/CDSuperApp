...
export default function UpdatesFeed() {
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      {/* Updates Feed */}
      <Text
        style={[styles.sectionTitle, { alignItems: 'center', bottom: '1%' }]}
      >
      ...
      {[
        ...
        <View key={index} style={styles.updateCard}>
          ...
          <Text style={styles.updateLabel}>
            <Text style={styles.bold}>Description:</Text> Short text summary of
...
const styles = StyleSheet.create({
  ...
  updateDate: { fontFamily: 'Inter_24pt-Bold', fontSize: 12, marginBottom: 6 },
  updateLabel: {
    fontSize: 12,
  ...
  bold: { fontFamily: 'Inter_24pt-Bold', fontSize: 12 },
  attachmentsRow: {
    flexDirection: 'row',
    justifyContent: 'flex-start',
    marginVertical: 5,
