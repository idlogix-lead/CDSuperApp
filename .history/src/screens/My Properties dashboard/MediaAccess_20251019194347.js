  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View
          style={{ height: 30, justifyContent: 'flex-start', marginTop: 10 }}
        >
        ...
        >
          <Text style={[styles.infoTxt, { textAlign: 'left' }]}>
             ℹ️ Security Note: Access restricted to verified property owners. Files
            and links are securely tied to your ownership record.
          </Text>
        </View>
        {/* Property Cards */}
      </ScrollView>
