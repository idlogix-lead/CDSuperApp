...
//         tabBarIndicatorStyle: { backgroundColor: '#0050C0' }, // Customize indicator color
//         tabBarStyle: {
//             marginTop: 20, // Adjust this value to move the TopTab down
//             backgroundColor: 'red', // For demonstration, customize background color
//         },
//     }}
// >
//     <TapTab.Screen name="AllTaskScreen" component={AllTaskScreen} />
//     <TapTab.Screen name="CloseStatusTicket" component={CloseStatusTricket} />
// </TapTab.Navigator>
//   );
// };
