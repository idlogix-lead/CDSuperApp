...
const PaymentBilling = () => <View style={styles.screen}><Text>Payment & Billing Screen</Text></View>;

const Notifications= () => <View style={styles.screen}><Text>Notifications Screen</Text></View>;
const Settings = () => <View style={styles.screen}><Text>Settings Screen</Text></View>;
const CustomerSupport = () => <View style={styles.screen}><Text>Customer Support Screen</Text></View>;
    ...
    <DrawerContentScrollView {...props} contentContainerStyle={{ flex: 1 }}>
      ...
      <View style={styles.drawerItemsContainer}>
        <DrawerItem
          ...
          icon={({ color, size }) => <Ionicons name="home" color={color} size={18} />}
          onPress={() => props.navigation.navigate("Home")}
        />
        <DrawerItem
          label="Payment & Billing"
          labelStyle={styles.drawerLabel}
          icon={({ color, size }) => <Ionicons name="card-outline" color={color} size={18} />}
          onPress={() => props.navigation.navigate("PaymentBilling")}
        />
        <DrawerItem
          label="Construction Updates"
          labelStyle={styles.drawerLabel}
          icon={({ color, size }) => <Ionicons name="business-outline" color={color} size={18} />}
          onPress={() => props.navigation.navigate("ConstructionUpdates")}
        />
        <DrawerItem
          label="Document Vault"
          labelStyle={styles.drawerLabel}
          icon={({ color, size }) => <Ionicons name="document-outline" color={color} size={18} />}
          onPress={() => props.navigation.navigate("DocumentDrawer")}
        />
        <DrawerItem
          label="My Profile & KYC"
          labelStyle={styles.drawerLabel}
          icon={({ color, size }) => <Ionicons name="person-outline" color={color} size={18} />}
          onPress={() => props.navigation.navigate("MyProfile")}
        />
        <DrawerItem
          label="Notifications"
          labelStyle={styles.drawerLabel}
          icon={({ color, size }) => <Ionicons name="notifications-outline" color={color} size={18} />}
          onPress={() => props.navigation.navigate("Notifications")}
        />
        <DrawerItem
          label="Settings"
          labelStyle={styles.drawerLabel}
          icon={({ color, size }) => <Ionicons name="settings-outline" color={color} size={18} />}
          onPress={() => props.navigation.navigate("Settings")}
        />
        <DrawerItem
          label="Customer Support"
          labelStyle={styles.drawerLabel}
          icon={({ color, size }) => <Ionicons name="call" color={color} size={18} />}
...
export default function App() {
  return (
      ...
      >
        ...
        <Drawer.Screen name="ConstructionUpdates" component={ConstructionDrawer} />
